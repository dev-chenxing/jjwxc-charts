    ...
    return new Promise(async (resolve, reject) => {
        ...
        await axios
            ...
            .then((response) => {
                ...
                novel["url"] = url;
                novel["genre"] = $("span[itemprop='genre']").text().trim().slice(6);
                ...
                console.log($("span[id='latestUpdates']")[0].prev.prev.firstChild.data.trim());
                novel["latestUpdates"] = $("span#latestUpdates")[0].prev.prev.text();
